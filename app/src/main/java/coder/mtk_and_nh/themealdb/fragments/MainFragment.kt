...
class MainFragment : Fragment() ,  CategoryAdapter.ClickListener , RandomAdapter.ClickListener{
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        randomAdapter.setOnClickListenerRandom(this)
        ...
        btnFirstLetter.setOnClickListener{
            var action= MainFragmentDirections.actionMainFragmentToAzListFragment()
            findNavController().navigate(action)
        }
    }
    ...
    override fun onClick(meal: Meal) {
        var action = MainFragmentDirections.actionMainFragmentToDetailFragment(meal.idMeal)
        findNavController().navigate(action)
    }
